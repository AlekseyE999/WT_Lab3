...
import code.by.tc.client.presentation.views.input.SetInputStudent;
import code.by.tc.client.presentation.viewModel.impl.EditModelView;
...
public class EditView extends PresentationView{
    ...
    public void show() {
        ...
        if (!this.studentService.editInfo(student)) {
